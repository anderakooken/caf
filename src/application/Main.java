...
public class Main extends Application {
	...
	public static String ldapServer = "192.168.254.216";
	...
	public static String getWeek(String date){
		...
		try {
			...
			switch (gc.get(Calendar.DAY_OF_WEEK)) {
		    	case Calendar.SUNDAY:	dayWeek = "DOM";	break;
		        case Calendar.MONDAY:	dayWeek = "SEG";	break;
		        case Calendar.TUESDAY:	dayWeek = "TER";	break;
		        case Calendar.WEDNESDAY:dayWeek = "QUA";	break;
		        case Calendar.THURSDAY:	dayWeek = "QUI";	break;
		        case Calendar.FRIDAY:	dayWeek = "SEX";	break;
		        case Calendar.SATURDAY:	dayWeek = "SAB";	break;
		    }
	...
	public static Boolean verifyJSON(String login, String password) {
		...
		try {
			...
			URL url = new URL("http://"+ldapServer+"/auth.php?auth&login="+login+"&passwd="+password+"");
